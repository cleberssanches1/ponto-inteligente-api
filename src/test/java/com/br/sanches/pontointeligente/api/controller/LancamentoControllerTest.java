...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
				.content(this.obterJsonRequisitionPost())
	...
	@Test
	@WithMockUser
	public void testCadastrarLancamentoFail() throws Exception {
	...
	/**
	 * 
	 * @return Obter Json Requisition Post
	 * @throws JsonProcessingException Exception
	 */
	private String obterJsonRequisitionPost() throws JsonProcessingException {
	...
	/**
	 * Obter Dados Lancamento
	 * @return Lancamento
	 */
	public Lancamento obterDadosLancamento() {
		
		Lancamento lancamento = new Lancamento();
		lancamento.setId(ID_FUNCIONARIO);
